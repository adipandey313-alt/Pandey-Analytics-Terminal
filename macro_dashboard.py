        ...
        with st.spinner(f"Pulling live SEC EDGAR & Market data for {ticker_input}..."):
            try:
                ...
                if 'shortName' in info:
                    ...
                    st.markdown("##### Enter Peer Tickers (comma-separated):")
                    peers_input = st.text_input("Peers", "NFLX, PARA, WBD", label_visibility="collapsed")
                        ...
                        with st.spinner("Compiling Peer Group Multiples..."):
                            ...
                            if comps_data:
                                ...
                                st.table(
                                    ...
                                    ).hide(axis="index").set_table_styles(TABLE_STYLES)
                                )
